 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t ousamalasri/food-delevery-app:${VERSION} .'
          sh 'docker push ousamalasri/food-delevery-app:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: ousamalasri\\/food-delevery-app:${VERSION}/" AWS/angular-manifest.yml
        '''
